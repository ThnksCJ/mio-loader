...
/*
 * Renamed from com.google.gson.bu
 */
final class bu_0
extends T {
    private final T b;
     ...
     */
    public bu_0(bt_0 bt_02, Gson gson, Type type, T t, Type type2, T t2, aT aT2) {
        this.a = bt_02;
        this.b = new bJ(gson, t, type);
        this.c = new bJ(gson, t2, type2);
        this.d = aT2;
    }
