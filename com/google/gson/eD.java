...
public class eD {
    ...
    public char b(char c2) {
        ...
        if (c3 != c2) {
            if (c3 > '\u0000') {
                throw this.b("Expected '" + c2 + "' and instead saw '" + c3 + "'");
            }
            throw this.b("Expected '" + c2 + "' and instead saw ''");
        }
        return c3;
    }
    ...
    public String a(String string) {
        ...
        while (true) {
            char c2;
            if (string.indexOf(c2 = this.e()) >= 0 || c2 == '\u0000' || c2 == '\n' || c2 == '\r') {
                if (c2 != '\u0000') {
                    this.b();
                }
                return stringBuilder.toString().trim();
