...
extends JsonReader {
    ...
    public void beginObject() {
        ...
        this.push(jsonObject.b().iterator());
    }
    ...
    public JsonToken f() {
        ...
        if (object instanceof Iterator) {
            boolean bl = this.d[this.e - 2] instanceof JsonObject;
    ...
    public String q() {
        ...
        for (int i = 0; i < this.e; ++i) {
            ...
            if (!(this.d[i] instanceof JsonObject) || ++i >= this.e || !(this.d[i] instanceof Iterator)) continue;
