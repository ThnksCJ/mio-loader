...
import me.mioclient.loader.discordipc.UnixPipe;
import me.mioclient.loader.discordipc.WindowsPipe;
...
public abstract class Pipe {
    ...
    public static Pipe a(Consumer consumer) {
        String string = System.getProperty("os.name").toLowerCase();
        if (string.contains("win")) {
            int n = 0;
            if (n < 10) {
                return new WindowsPipe("\\\\?\\pipe\\discord-ipc-" + n, consumer);
            }
        } else {
            String string2;
            Object object = null;
            ...
            int n2 = 0;
            if (n2 < 10) {
                return new UnixPipe((String)object + n2, consumer);
            }
        }
        return null;
    }
     ...
     */
    public void a(dg dg2, C c) {
        c.a("nonce", UUID.randomUUID().toString());
        byte[] byArray = c.toString().getBytes();
        ByteBuffer byteBuffer = ByteBuffer.allocate(byArray.length + 8);
        byteBuffer.putInt(Integer.reverseBytes(dg2.ordinal()));
...
lbl1:
                        ...
                        Pipe.field282 = 27259 ^ -25803;
                        Pipe.field283 = -29204 ^ -25803;
                        Pipe.b = new int[4][1];
                        var13 = new String[10];
                        var11_1 = 0;
...
lbl107:
        ...
        Pipe.g = var6_8;
        Pipe.h = new Integer[3];
        Pipe.a = new String[]{"XDG_RUNTIME_DIR", "TMPDIR", "TMP", "TEMP"};
        ** while (true)
    }
}
