...
extends Pipe {
     ...
     */
    WindowsPipe(String string, Consumer consumer) {
    ...
    private void b() {
        ...
        while (true) {
            this.b(byteBuffer);
            dg dg2 = dg.a(Integer.reverseBytes(byteBuffer.getInt(0)));
            this.b(byteBuffer);
            ...
            this.b.accept(new dh(dg2, DocumentConsumer.a(string).u()));
        }
    }
...
lbl1:
                ...
                WindowsPipe.field282 = 10407 ^ -14310;
                WindowsPipe.field283 = -14654 ^ -14310;
                WindowsPipe.d = new int[1][3];
                var7 = new String[2];
                var5_1 = 0;
...
lbl68:
            ...
            WindowsPipe.c = var7;
            WindowsPipe.f = new String[2];
            break block17;
lbl78:
            // 1 sources

            while (true) {
                WindowsPipe.i = 1385882223152922738L ^ var0_7;
                ** continue;
                break;
            }
        }
