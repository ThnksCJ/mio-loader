...
import me.mioclient.loader.gson.cL;
import me.mioclient.loader.gson.cP;
            ...
            switch (c) {
                ...
                default: {
                    ...
                    if (n3 == 2) {
                        ...
                        long l2 = l * JsonReader.c(11501, 8871588967825355201L) - (long)(c - 48);
        ...
        switch (c) {
            case 'u': {
                ...
                for (n = this.F; n < n2; ++n) {
                    ...
                    if (c3 >= 'a' && c3 <= JsonReader.a((int)95, (long)2173383065210468743L)) {
                        c2 = (char)(c2 + (c3 - 97 + 10));
                        continue;
                    }
                    if (c3 >= 'A' && c3 <= 'F') {
