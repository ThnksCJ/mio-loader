...
import me.mioclient.loader.gson.a;
...
/*
 * Renamed from me.mioclient.loader.gson.t
 */
public final class t_0 {
     ...
     * Lifted jumps to return sites
     */
    t_0(GSONBuilder gSONBuilder) {
        this.a = gSONBuilder.i;
        this.c = gSONBuilder.j;
        this.d.putAll(gSONBuilder.k);
        this.g = gSONBuilder.l;
        this.k = gSONBuilder.m;
        this.o = gSONBuilder.n;
        this.m = gSONBuilder.o;
        this.n = gSONBuilder.p;
        this.p = gSONBuilder.q;
        this.l = gSONBuilder.r;
        this.b = gSONBuilder.v;
        this.h = gSONBuilder.s;
        this.i = gSONBuilder.t;
        this.j = gSONBuilder.u;
        this.e.addAll(gSONBuilder.w);
        this.f.addAll(gSONBuilder.x);
        this.q = gSONBuilder.y;
        this.r = gSONBuilder.z;
    }
    ...
    public GSONBuilder j() {
        ...
        return new GSONBuilder(this.a, this.c, this.d, this.g, this.k, this.o, this.m, this.n, this.p, this.l, this.b, this.h, this.i, this.j, this.e, this.f, arrayList, this.q, this.r);
    }
