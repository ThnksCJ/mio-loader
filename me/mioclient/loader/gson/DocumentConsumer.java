...
public final class DocumentConsumer {
    ...
    public static JsonElement a(String string) {
        return DocumentConsumer.a(new StringReader(string));
    }

    public static JsonElement a(Reader reader) {
        JsonReader jsonReader = new JsonReader(reader);
        JsonElement jsonElement = DocumentConsumer.a(jsonReader);
    ...
    public JsonElement b(String string) {
        return DocumentConsumer.a(string);
    }

    public JsonElement b(Reader reader) {
        return DocumentConsumer.a(reader);
    }

    public JsonElement b(JsonReader jsonReader) {
        return DocumentConsumer.a(jsonReader);
    }
...
lbl1:
            ...
            DocumentConsumer.field36 = 17590 ^ -2730;
            DocumentConsumer.field37 = -22524 ^ -2730;
            DocumentConsumer.c = new int[3][1];
            var5 = new String[5];
            var3_1 = 0;
...
lbl36:
            ...
            while (true) {
                ...
                DocumentConsumer.a = var5;
                DocumentConsumer.b = new String[5];
                ** continue;
                break;
            }
        }
